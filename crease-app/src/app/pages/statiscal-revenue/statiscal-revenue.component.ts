  ...
  customsData(list: any) {
    ...
    if (list.length > 0) {
      for (let i = 0; i < list.length; i++) {
        ...
        list[i].dateCustoms = list[i].date
          ? this.typeShow !== 1
            ? list[i].date
            : moment(list[i].date, 'YYYYMMDD').format('DD/MM/YYYY')
          : '';
      }
    }
      ...
      series: [
        {
          data: [
            {
              name:
                'Chi phí giá vốn: ' + this.plugins.formatNumber(tGiaVon) + 'đ',
              y: tGiaVon,
              color: '#FF4747',
            },
            {
              name:
                'Chi phí vận hành: ' +
                this.plugins.formatNumber(tVanHanh) +
                'đ',
              y: tVanHanh,
              color: '#47AC4F',
            },
            ...
            },
            {
              name:
                'Chi phí vận chuyển: ' +
                this.plugins.formatNumber(tvanChuyen) +
                'đ',
              y: tvanChuyen,
              color: '#C8930C',
            },
            {
              name:
                'Chi phí marketing: ' + this.plugins.formatNumber(tMKT) + 'đ',
              y: tMKT,
              color: '#C8B216',
            },
          ],
