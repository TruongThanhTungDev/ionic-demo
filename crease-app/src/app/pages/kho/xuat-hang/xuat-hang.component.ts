...
import { XulyPhieuXuatComponent } from 'src/app/shared/popup/them-sua-kho/them-sua-phieu-xuat/xu-ly-phieu-xuat.component';
@Component({
  selector: 'xuathang-component',
...
export class XuatHangComponent implements OnInit {
  ...
  async addPhieuXuat() {
    const modal = await this.modal.create({
      component: XulyPhieuXuatComponent,
      componentProps: {
        title: 'Xuất hàng',
        data: null,
        type: 'add',
  ...
  async editInfoPhieuXuat(item: any) {
    const modal = await this.modal.create({
      component: XulyPhieuXuatComponent,
      componentProps: {
        title: 'Xuất hàng',
